...
=head1 NAME
 ...
 getTranslations.pl - Get valid proteins 

=head1 SYNOPSIS

  % getTranslations.pl --fna file1.fna --minlen 30 --out out.faa
  
=head1 DESCRIPTION

 Translating DNA to find un annotated genes. 
 Stopping translation if a STOP codon in encountered. 
 The fasta header of proteins contain genome coordinates
...
=cut
my($fna,$len,$out,$i,$j,$rec,@gff_genes,@temp,$seqObj,$k,$l);
